...
.constant('DB_CONFIG', {
  ...
  datas: [
    {
      name: 'ingredients',
      columns : ["'name_fr', 'name_en', 'name_de', 'name_es', 'name_pt', 'name_zh', 'masse_volumique', 'ref'"], // Masse volumique en g / L
      rows:[
    ...
    },
    {
      ...
      columns : ["'code', 'name_fr', 'name_en', 'name_de', 'name_es', 'name_pt', 'name_zh'"],
      rows:[
        "'M', 'Métrique', 'Metric', 'Metrisch', 'Sistema métrico', 'Métrico', '公制'",
        "'I', 'Impérial UK', 'Imperial UK', 'Imperial UK', 'Imperial UK', 'Imperial UK', '英制 UK'",
        "'A', 'Impérial US', 'Imperial US', 'Imperial US', 'Imperial US', 'Imperial US', '英制 US'" ]
      },
      {
        name: 'types', // Type d'unité pour la conversion (tout en Litre ou Kilo)
        columns : ["'code', 'name_fr', 'name_en', 'name_de', 'name_es', 'name_pt', 'name_zh', 'type', 'ref', 'rapport'"],
        rows:[
          "'tsp', 'cuillère à café', 'teaspoon', 'kaffeelöffel', 'cucharilla ', 'colher de cafe', '茶匙', 'volume', 'M', 202.884136211058",
          "'Tbsp', 'cuillère à soupe', 'tablespoon', 'suppenlöffel', 'cucharada', 'colher de sopa', '汤匙', 'volume', 'M', 67.688045403686",
          "'cp', 'tasse', 'cup', 'tasse', 'taza', 'taça', '杯', 'volume', 'M', 4",
          "'cp UK', 'tasse UK', 'cup UK', 'tasse UK', 'taza UK', 'taça UK', '杯 UK', 'volume', 'M', 3.531938659055",
          "'cp US', 'tasse US', 'cup US', 'tasse US', 'taza US', 'taça US', '杯 US', 'volume', 'M', 4.226752837730",
          "'Ml', 'millilitre', 'milliliter', 'milliliter', 'mililitro', 'mililitro', '毫升', 'volume', 'M', 1000",
          "'Cl', 'centilitre', 'centiliter', 'zentiliter', 'centilitro', 'centilitro', '厘升', 'volume', 'M', 100",
          "'Dl', 'décilitre', 'deciliter', 'deziliter', 'decilitro', 'decilitro', '分升', 'volume', 'M', 10",
          "'L', 'litre', 'liter', 'liter', 'litro', 'litro', '升', 'volume', 'M', 1",
          "'Kg', 'kilogramme', 'kilogram', 'kilogramm', 'kilogramo', 'quilograma', '公斤', 'poids', 'M', 1",
          "'g', 'gramme', 'gram', 'gramm', 'gramo', 'grama', '克', 'poids', 'M', 1000",
          "'mg', 'milligramme', 'milligram', 'milligramm', 'miligramo', 'miligrama', '毫克', 'poids', 'M', 1000000",

          "'tsp', 'cuillère à café', 'teaspoon', 'kaffeelöffel', 'cucharilla ', 'colher de cafe', '茶匙', 'volume', 'A', 202.884136211058",
          "'Tbsp', 'cuillère à soupe', 'tablespoon', 'suppenlöffel', 'cucharada', 'colher de sopa', '汤匙', 'volume', 'A', 67.688045403686",
          "'fl oz US', 'once liquide US', 'fuild ounce US', 'flüssigunzen US', 'oz de líquido US', 'onça fluida US', '液体盎司 US', 'volume', 'A', 33.814022701843",
          "'cp US', 'tasse US', 'cup US', 'tasse US', 'taza US', 'taça US', '杯 US', 'volume', 'A', 4.226752837730",
          "'pt US', 'pinte US', 'pint US', 'pint US', 'pinta US', 'quartilho US', '品脱 US', 'volume', 'A', 2.113376418865",
          "'gal US', 'gallon US', 'gallon US', 'gallone US', 'galón US', 'galão US', '加仑 US', 'volume', 'A', 0.264172052358",
          "'oz', 'once', 'ounce', 'unze', 'onza', 'onça', '盎司', 'poids', 'A', 35.273368606702",
          "'lbs', 'livre', 'pound', 'pfund', 'libra', 'libra', '磅', 'poids', 'A', 2.204585537919",

          "'tsp', 'cuillère à café', 'teaspoon', 'kaffeelöffel', 'cucharilla ', 'colher de cafe', '茶匙', 'volume', 'I', 202.884136211058",
          "'Tbsp', 'cuillère à soupe', 'tablespoon', 'suppenlöffel', 'cucharada', 'colher de sopa', '汤匙', 'volume', 'I', 67.688045403686",
          "'fl oz UK', 'once liquide UK', 'fuild ounce UK', 'flüssigunzen UK', 'oz de líquido UK', 'onça fluida UK', '液体盎司 UK', 'volume', 'I', 35.222429643197",
          "'cp UK', 'tasse UK', 'cup UK', 'tasse UK', 'taza UK', 'taça UK', '杯 UK', 'volume', 'I', 3.531938659055",
          "'pt UK', 'pinte UK', 'pint UK', 'pint UK', 'pinta UK', 'quartilho UK', '品脱 UK', 'volume', 'I', 1.733667122043",
          "'gal UK', 'gallon UK', 'gallon UK', 'gallone UK', 'galón UK', 'galão UK', '加仑 UK', 'volume', 'I', 0.220143093010",
          "'oz', 'once', 'ounce', 'unze', 'onza', 'onça', '盎司', 'poids', 'I', 35.273368606702",
          "'lbs', 'livre', 'pound', 'pfund', 'libra', 'libra', '磅', 'poids', 'I', 2.204585537919"
        ]
      },
      {
        name: 'languages',
