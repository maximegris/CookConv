...
angular.module('db.config').constant('DB_CONFIG', {
  ...
  tables: [{
    ...
    columns: [{
        ...
        name: 'ref',
        type: 'boolean'
      } // True si référentiel, false si crée par utilisateur
    ]
  }, {
    ...
    columns: [{
      ...
      }, // Poids / volume
      {
        name: 'rapport',
        type: 'numeric'
      } // Soit au litre, soit au kilo en fonction du type
    ]
  }, {
    ...
    columns: [{
        name: 'current_lang',
        type: 'text'
      }, // Langue de l'application (code de la table languages),
      {
        name: 'current_lang_label',
        type: 'text'
      }, // Langue de l'application (label de la table languages),
      {
        name: 'db_version',
        type: 'integer'
  ...
  datas: [{
    ...
    columns: ["'code', 'name_fr', 'name_en', 'name_de', 'name_es', 'name_pt', 'name_zh', 'type', 'rapport'"],
    rows: [
